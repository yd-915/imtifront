      ...
      <div className="relative flex flex-col px-10 mx-auto space-y-5 md:w-3/4">
        <header className="flex items-center justify-between space-x-3">
          ...
          >
            <nav className="flex flex-col w-full space-x-0 space-y-3 text-center md:space-y-0 md:space-x-3 md:flex-row">
              <a className="px-5 py-2 rounded text-violet-500 hover:bg-white-100">About</a>
              <a className="px-5 py-2 rounded text-violet-500 hover:bg-white-100">Pricing</a>
              <a className="px-5 py-2 rounded text-violet-500 hover:bg-white-100">Testimonials</a>
        ...
        <div className="flex flex-col items-center justify-center pt-10 mx-auto md:w-3/5">
          <h1 className="text-6xl font-extrabold text-center">
            ...
            <span className="block text-violet-500">The Ultimate API Platform Is Here!</span>
          </h1>
